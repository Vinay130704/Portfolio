...
export const personalInfo = {
  ...
  linkedin: "#",
  twitter: "#",
  bio: "Final Year B.Tech CSE student with a passion for video editing and digital content creation. Currently working as a Freelance Video Editor for Lone_Warriors, a Valorant-focused YouTube channel, where I edit gaming videos, highlight reels, and short-form content using CapCut. My technical background in Computer Science combined with hands-on content creation experience gives me a unique edge in understanding both the creative and digital aspects of media production.",
...
export const experiences = [
  {
    ...
    company: "Lone_Warriors",
    organization: "Valorant YouTube Channel",
    location: "Remote",
    duration: "2024 - Present",
    type: "Freelance",
    description: [
      "Edited high-energy gaming videos and short-form reels for a Valorant-focused YouTube channel",
      "Created engaging montages, highlight clips, and reels optimized for YouTube and social media platforms",
      "Applied motion graphics, transitions, sound effects, and color grading to enhance viewer experience",
      "Consistently delivered content aligned with the channel's branding and audience preferences"
    ],
    technologies: ["CapCut", "Video Editing", "Motion Graphics", "Color Grading", "Sound Design"]
  },
  {
    id: 2,
    title: "Intern",
...
export const education = [
  {
    ...
    duration: "2022 - 2026",
    description: "SGPA: 7.0 | Final Year B.Tech CSE student"
  },
  {
    id: 2,
